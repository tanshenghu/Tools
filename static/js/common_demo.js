...
var tsh_js_key = $.tsh.remark.key,
	tsh_js_demo = {
		...
		"checkIE" : "<label>\/\/ 判断是否IE浏览器，返回值true or false，注意：不是方法，它是成员属性</label>",
		...
		"other" : "<label>\/\/ 还有一些其它的方法，没有挂接在tsh下面，对原生的对象的一些扩展。如下：<br> String &lt; trim(),rtrim(','),ltrim('|') &gt; 参数都是可选，如果填写参数就是找到那个字符再删除<br> Array &lt; delVal(val, repeat),clearRepeat() &gt; <br> window &lt; getComputedStyle(obj)['color'] &gt;</label>"
};
...
var tsh_js_show_demo = function( key ){
	...
	htmlStr += tsh_js_demo[key] || '<h2>\u6CA1\u6709\u67E5\u627E\u5230<b class="green">'+key+'</b>\uFF0C\u8BF7\u6CE8\u610F\u5927\u5C0F\u5199\u6216\u8054\u7CFB\u4F5C\u8005<a target=blank class=blue href=http://wpa.qq.com/msgrd?V=1&Uin=511568692>TanShenghu</a></h2>';
